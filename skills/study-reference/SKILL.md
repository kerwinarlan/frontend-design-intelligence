...
* Adding new benchmark reference entries to `knowledge/references/`.
...
* Identify what makes the design successful.
* Identify context-specific elements that should NOT be copied blindly.
